...
import { register, login, forgotPassword, resetPassword, verifyEmail, logout } from './authController';
...
describe('authController', () => {
  ...
  describe('register', () => {
    it('should register a user successfully', async () => {
      ...
      expect(res.json).toHaveBeenCalledWith({ message: 'User registered successfully. Please check your email for verification.', userId: mockUser.id });
    });
  ...
  describe('resetPassword', () => {
    ...
    it('should handle invalid or expired token on reset password', async () => {
      vi.spyOn(authService, 'resetUserPassword').mockRejectedValue(new Error('Invalid or expired token'));
  ...
  describe('verifyEmail', () => {
    ...
    it('should handle invalid or expired verification token', async () => {
      ...
      vi.spyOn(authService, 'verifyUserEmail').mockRejectedValue(new Error('Invalid or expired verification token'));
